from saeco.architectures.sweep_tg.orig_rewrite.tg_arch import (
    TGArch,
    TGSAEConfig,
)
...
cfg = RunConfig[TGSAEConfig](
    train_cfg=TrainConfig(
        ...
        #
        l0_target=50,
        l0_target_adjustment_size=0.00,
        coeffs={
            "sparsity_loss": 2.0e-3,
            "L2_loss": 1,
        },
        #
        ...
        thresh_gate_cfg=ThreshGateConfig(
            ...
            gate_cfg=GatingConfig(
                gate_cfg=GateFunctionConfig(
                    ...
                    # it being of is like... clearly incorrect or something
