...
if __name__ == "__main__":
    ...
    cfg = RunConfig[ResidConfig](
        train_cfg=TrainConfig(
            ...
            lr=1e-3,
            # lr=Swept(3e-4, 1e-3),
            betas=Swept[tuple[float, float]]((0.9, 0.997)),
        ...
        arch_cfg=ResidConfig(
            layers=4,
            pre_bias=False,
            individual_dec_bias=Swept(True, False),
            individual_enc_bias=Swept(True, False),
            anth_scale=False,
            thresh_range=Swept[tuple[float, float]]((1, 0), (1, 0.2), (1, 1)),
            ...
            #     (0, 0.5),
            # ),
            reuse_layer=Swept[ReuseLayer](1, 2, 5),
        ),
    )
